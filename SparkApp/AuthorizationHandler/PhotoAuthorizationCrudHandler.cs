...
{
    public class PhotoAuthorizationCrudHandler : AuthorizationHandler<OperationAuthorizationRequirement, SparkService.Models.Photos>
    {
        private readonly SubscriptionService _subscriptionService;
        private readonly string serviceName = "photos";

        public PhotoAuthorizationCrudHandler(SubscriptionService subscriptionService) => (_subscriptionService) = (subscriptionService);
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, OperationAuthorizationRequirement requirement, SparkService.Models.Photos resource)
        {
        ...
        private List<OperationAuthorizationRequirement> GetAllowedOperations(ClaimsPrincipal user, SparkService.Models.Photos resource)
        {
