...
{
    public class InterestsAuthorizationCrudHandler : AuthorizationHandler<OperationAuthorizationRequirement, SparkService.Models.Interests>
    {
        private readonly SubscriptionService _subscriptionService;
        private readonly string serviceName = "interests";

        public InterestsAuthorizationCrudHandler(SubscriptionService subscriptionService) => (_subscriptionService) = (subscriptionService);

        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, OperationAuthorizationRequirement requirement, SparkService.Models.Interests resource)
        {
        ...
        private List<OperationAuthorizationRequirement> GetAllowedOperations(ClaimsPrincipal user, SparkService.Models.Interests resource)
        {
